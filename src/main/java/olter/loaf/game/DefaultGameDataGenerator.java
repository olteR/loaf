...
//            new AbilityEntity(1L, List.of("city", "coins"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Kapsz egy <b><i class=\"fa fa-coins\"></i></b> a városodban lévő minden egyes <span style=\"font-variant: small-caps\">nemesi</span> <i class=\"fa fa-city\"></i> után.</p>"),
//            new AbilityEntity(2L, List.of("city", "sheet-plastic"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Kapsz egy <b><i class=\"fa fa-sheet-plastic\"></i></b> a városodban lévő minden egyes <span style=\"font-variant: small-caps\">nemesi</span> <i class=\"fa fa-city\"></i> után.</p>"),
//            new AbilityEntity(3L, List.of("city", "coins"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Kapsz egy <b><i class=\"fa fa-coins\"></i></b> a városodban lévő minden egyes <span style=\"font-variant: small-caps\">vallási</span> <i class=\"fa fa-city\"></i> után.</p>"),
//            new AbilityEntity(4L, List.of("city", "sheet-plastic"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Kapsz egy <b><i class=\"fa fa-sheet-plastic\"></i></b> a városodban lévő minden egyes <span style=\"font-variant: small-caps\">vallási</span> <i class=\"fa fa-city\"></i> után.</p>"),
//            new AbilityEntity(5L, List.of("city", "coins", "sheet-plastic"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.GOLD_OR_CARDS_MULTIPLE, "<p>Kapsz egy <b><i class=\"fa fa-coins\"></i>-t</b> vagy <b><i class=\"fa fa-sheet-plastic\"></i>-t</b> a városodban lévő minden <span style=\"font-variant: small-caps\">egyházi</span> <i class=\"fa fa-city\"></i> után.</p>"),
//            new AbilityEntity(6L, List.of("city", "coins"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Kapsz egy <b><i class=\"fa fa-coins\"></i></b> a városodban lévő minden egyes <span style=\"font-variant: small-caps\">kereskedelmi</span> <i class=\"fa fa-city\"></i> után.</p>"),
//            new AbilityEntity(7L, List.of("city", "coins"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Kapsz egy <b><i class=\"fa fa-coins\"></i></b> a városodban lévő minden egyes <span style=\"font-variant: small-caps\">katonai</span> <i class=\"fa fa-city\"></i> után.</p>"),
//            new AbilityEntity(8L, List.of("crown", "hand"), ActivationEnum.MANUAL, AbilityUsageEnum.MUST, AbilityTargetEnum.NONE, "<p>A köröd során el kell venned a <i class=\"fa fa-crown\"></i>-t. A karakter választási fázisban te választasz először karaktert, amíg egy másik játékos nem választja a Királyt.</p><p>Ha meggyilkolnak, akkor ugyanúgy kihagyod a körödet, mint bármely más karakter, a <i class=\"fa fa-crown\"></i> pedig nálad marad, mint trónörökösnél.</p><p>Ha megbabonáznak, attól még megtartod a <i class=\"fa fa-crown\"></i>-t.</p>"),
//            new AbilityEntity(9L, List.of("user", "skull"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.CHARACTER, "<p>Válassz egy másik karaktert, akit meg szeretnél gyilkolni! A meggyilkolt karakter kihagyja az egész körét.</p>"),
//            new AbilityEntity(10L, List.of("user", "sack-dollar"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.CHARACTER, "<p>Válaszd ki, hogy melyik karaktertől szeretnél lopni! Amikor az a karakter következik, elveszed a kincstartalékában lévő összes <i class=\"fa fa-coins\"></i>-t.</p><p>Nem rabolhatsz ki 1-es rangú karkatert, megölt vagy megbabonázott karaktert.</p>"),
//            new AbilityEntity(11L, List.of("user", "sheet-plastic"), ActivationEnum.MANUAL, AbilityUsageEnum.OR, AbilityTargetEnum.PLAYER, "<p>Kicserélheted a kezedben lévő összes <i class=\"fa fa-sheet-plastic\"></i>-t egy másik játékos kezében lévő <i class=\"fa fa-sheet-plastic\"></i>-okra.</p>"),
//            new AbilityEntity(12L, List.of("sheet-plastic", "rotate"), ActivationEnum.MANUAL, AbilityUsageEnum.OR, AbilityTargetEnum.OWN_CARDS, "<p>Tetszőleges számú <i class=\"fa fa-sheet-plastic\"></i>-t eldobhatsz a kezedből és húzol helyettük ugyanannyit.</p>"),
//            new AbilityEntity(13L, List.of(), ActivationEnum.START_OF_TURN, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Ebben a körben a 8-as rangú karakter nem használhatja képességét a <i class=\"fa fa-city\"></i>-eiden.</p><p>Ha megölnek, nyolcas rangú karakter <b>tudja</b> használni a képességét a <i class=\"fa fa-city\"></i>-eiden. Ugyanígy, ha megbabonáznak, nyolcas rangú karakter <b>nem tudja</b> használni a képességeit a Boszorkány <i class=\"fa fa-city\"></i>-ein, de <b>képes</b> használni a képességét a Püspök <i class=\"fa fa-city\"></i>-ein.</p>"),
//            new AbilityEntity(14L, List.of("coins", "plus"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Kapsz plusz egy <i class=\"fa fa-coins\"></i>-t.</p>"),
//            new AbilityEntity(15L, List.of("sheet-plastic", "plus"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Kapsz két plusz <i class=\"fa fa-sheet-plastic\"></i>-t.</p>"),
//            new AbilityEntity(16L, List.of(), ActivationEnum.START_OF_TURN, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Ebben a körben az építkezési korlátod 3 <i class=\"fa fa-city\"></i>.</p>"),
//            new AbilityEntity(17L, List.of("city", "x"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.BUILT_DISTRICT, "<p>Elpusztíthatsz egy tetszőleges <i class=\"fa fa-city\"></i>-t: ez eggyel kevesebb <i class=\"fa fa-coins\"></i>-ba kerül, mint amennyi az ára.</p><p>Nem pusztíthatsz el befejezett városban <i class=\"fa fa-city\"></i>-t, de saját <i class=\"fa fa-city\"></i>-eid egyikét igen.</p>"),
//            new AbilityEntity(18L, List.of("crown", "coins"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Ha a sorban egy melletted lévő játékos 4-es rangú karaktert választott, kapsz 3 <i class=\"fa fa-coins\"></i>-t. Ha ezt a karaktert megöli az Orgyilkos, az <i class=\"fa fa-coins\"></i>-t a kör legvégén kapod meg.</p>"),
//            new AbilityEntity(19L, List.of("user", "wand-sparkles"), ActivationEnum.MANUAL, AbilityUsageEnum.MUST, AbilityTargetEnum.CHARACTER, "<p>Nyersanyag gyűjtés után ki kell választanod melyik karaktert szeretnéd megbabonázni, ekkor a köröd felfüggesztésre kerül! Ekkor nem tudsz építkezni, és a <i class=\"fa fa-city\"></i>-ek közül csak azok hatása érvényesül, amik nyersanyagokat gyűjtenek.</p><p>Amikor a megbabonázott karakter kerül sorra, a játékos nyersanyagokat gyűjt, és azonnal véget kell vetnie a körének. Nem képes <i class=\"fa fa-city\"></i>-t építeni sem, karakterek képességeit használni — még azokat sem, amik <q>plusz</q> nyersanyagokat adnak. A <i class=\"fa fa-city\"></i>-ek közül csak azok hatása érvényesül a megbabonázott karakter esetében, amik nyersanyagokat gyűjtenek.</p><p>Ezután úgy folytatod a körödet, mintha te játszanál a megbabonázott karakterrel: használod a képességeit, beleértve a plusz nyersanyagokat adókat, a passzívakat, és a megkötéseket. A <b>te</b> kezedben lévő <i class=\"fa fa-sheet-plastic\"></i>-okkal játszol, a <b>te</b> kincstartalékodban lévő <i class=\"fa fa-coins\"></i>-al fizetsz, a <b>te</b> városod <i class=\"fa fa-city\"></i>-eiből gyűjtesz nyersanyagokat, a <b>te</b> városodban építesz új kerületeket. Nem tudod használni a megbabonázott játékos bírtokában lévő <span style=\"font-variant: small-caps\">egyedi</span> <i class=\"fa fa-city\"></i>-ek hatásait.</p><p>Ha a Királyt vagy a Patríciust babonázzák meg, varázslattól függetlenül megkapja a <i class=\"fa fa-crown\"></i>-t. Ha a Császárt babonázzák meg, te döntöd el, ki kapja a <i class=\"fa fa-crown\"></i>-t, és attól a játékostól veszed el a nyersanyagot.</p><p>Ha a megbabonázott karakter nincs játékban ebben a körben, a köröd nem folytatódik.</p>"),
//            new AbilityEntity(20L, List.of("sheet-plastic", "user-secret"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.PLAYER_AND_DISTRICT_TYPE, "<p>Válassz ki egy másik játékost és egy kerülettípust! Ezután megnézheted a másik játékos kezében lévő <i class=\"fa fa-sheet-plastic\"></i>-okat. Minden olyan <i class=\"fa fa-sheet-plastic\"></i>-ért, ami a kezében van, és egyezik a megnevezett kerülettípussal elveszel tőle egy <i class=\"fa fa-coins\"></i>-t és húzol egy <i class=\"fa fa-sheet-plastic\"></i>-t a pakliból.</p><p>Ha több egyező <i class=\"fa fa-sheet-plastic\"></i> van, mint amennyi <i class=\"fa fa-coins\"></i>-a, akkor elveszed minden <i class=\"fa fa-coins\"></i>-át, de ettől még ugyanúgy megkapod a <i class=\"fa fa-sheet-plastic\"></i>-okat.</p>"),
//            new AbilityEntity(21L, List.of("sheet-plastic", "wand-magic-sparkles"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.PLAYER_AND_DISTRICT_IN_HAND, "<p>Megnézheted egy másik játékos kézben tartott <i class=\"fa fa-sheet-plastic\"></i>-jait, majd elvehetsz tőle egyet. A <i class=\"fa fa-sheet-plastic\"></i>-t azonnal beépítheted a városodba, és ez nem számít bele az építkezési korlátba.</p>"),
//            new AbilityEntity(22L, List.of(), ActivationEnum.START_OF_TURN, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Ebben a körben olyan <i class=\"fa fa-city\"></i>-eket is építhetsz a városodban, amilyenek már léteznek.</p>"),
//            new AbilityEntity(23L, List.of("crown", "user"), ActivationEnum.MANUAL, AbilityUsageEnum.MUST, AbilityTargetEnum.PLAYER, "<p>Valamikor a köröd során el kell venned a <i class=\"fa fa-crown\"></i>-t attól a játékostól akinél van és át kell adnod egy másik játékosnak (magadnak nem adhatod). Az a játékos, aki megkapta a <i class=\"fa fa-crown\"></i>-t, ad neked egy <i class=\"fa fa-coins\"></i>-t vagy véletlenszerűen egy <i class=\"fa fa-sheet-plastic\"></i>-t a kezéből. Ha nincs sem <i class=\"fa fa-coins\"></i>-a, sem <i class=\"fa fa-sheet-plastic\"></i>-ja, akkor nem kell adnia semmit.</p><p>Ha meggyilkolnak, a köröd végén teszed át a koronát és nem kapsz érte nyersanyagot.</p>"),
//            new AbilityEntity(24L, List.of("user", "coins"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.RICHEST_PLAYER, "<p>Ha a köröd során bármikor előfordul, hogy nem te vagy a legtöbb <i class=\"fa fa-coins\"></i>-al rendelkező játékos, a leggazdagabb játékos ad neked egyet. Döntetlen esetén te választasz, hogy ki ad <i class=\"fa fa-coins\"></i>-t.</p>"),
//            new AbilityEntity(25L, List.of(), ActivationEnum.END_OF_TURN, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A köröd végén minden építésre költött <i class=\"fa fa-coins\"></i>-t visszakapsz.</p>"),
//            new AbilityEntity(26L, List.of("4", "coins", "sheet-plastic"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.GOLD_OR_CARDS, "<p>Kapsz 4 <i class=\"fa fa-coins\"></i>-t, vagy 4 <i class=\"fa fa-sheet-plastic\"></i>-t.</p>"),
//            new AbilityEntity(27L, List.of(), ActivationEnum.START_OF_TURN, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Nem építhetsz semmilyen kerületet ebben a körben.</p>"),
//            new AbilityEntity(28L, List.of("city", "right-left"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.BUILT_DISTRICT, "<p>Kicserélheted az egyik <i class=\"fa fa-city\"></i>-edet egy másik játékos <i class=\"fa fa-city\"></i>-ére. Ha az elvett <i class=\"fa fa-city\"></i> értéke nagyobb, a különbözet árát ki kell fizetned neki!</p><p>Nem cserélheted ki befejezett város <i class=\"fa fa-city\"></i>-ét, kivéve ha a sajátod. Nem adhatsz olyan <i class=\"fa fa-city\"></i>-et, ami már van a másik játékos városában és nem vehetsz el olyat, amilyen már van a tiedben.</p>"),
//            new AbilityEntity(29L, List.of("city", "paintbrush"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.OWN_BUILT_DISTRICT, "<p>Megszépíthetsz legfejlebb 2 <i class=\"fa fa-city\"></i>-et, fejenként 1 <i class=\"fa fa-coins\"></i>-ért cserébe. A megszépített <i class=\"fa fa-city\"></i>-ek értéke egyel nő a játék végéig. Egy <i class=\"fa fa-city\"></i>-et csak egyszer lehet megszépíteni.</p>"),
//            new AbilityEntity(30L, List.of("user", "file-signature"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.WARRANTS, ""),
//            new AbilityEntity(31L, List.of("user", "mask"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.THREAT_MARKERS, ""),
//            new AbilityEntity(32L, List.of("users", "hand-sparkles"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.SHUFFLE, "<p>Véletlenszerűen kapsz egy <i class=\"fa fa-sheet-plastic\"></i>-t minden játékos kezéből. Ezután adnod kell minden játékosnak egy lapot a kezedből. Ha egy játékosnak nincs <i class=\"fa fa-sheet-plastic\"></i> a kezében, nem veszel tőle <i class=\"fa fa-sheet-plastic\"></i>-t és nem is adsz neki</p>"),
//            new AbilityEntity(33L, List.of(), ActivationEnum.START_OF_TURN, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Ebben a körben az építkezési korlátod 2 <i class=\"fa fa-city\"></i>.</p>"),
//            new AbilityEntity(34L, List.of("hammer", "hand-holding-dollar"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.DISTRICT_AND_PLAYER_HELP, "<p>Megépíthetsz egy <i class=\"fa fa-city\"></i>-et, amire nincs elég <i class=\"fa fa-coins\"></i>-ad. Ehhez ki kell választanod egy másik játékost és elvenni tőle a megépítéshez szükséges <i class=\"fa fa-coins\"></i>-at, cserébe pedig adnod kell ugyannyi <i class=\"fa fa-sheet-plastic\"></i>-t a kezedből."),
//            new AbilityEntity(35L, List.of(), ActivationEnum.START_OF_TURN, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Bármennyi <span style=\"font-variant: small-caps\">kereskedelmi</span> kerületet építhetsz.</p>"),
//            new AbilityEntity(36L, List.of("7", "sheet-plastic"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.SELECTOR, "<p>Húzol 7 <i class=\"fa fa-sheet-plastic\"></i>-t és választasz egyet, amit megtarthatsz.</p>"),
//            new AbilityEntity(37L, List.of("city", "hand"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.CHEAP_BUILT_DISTRICT, ""),
//            new AbilityEntity(38L, List.of("users", "coins"), ActivationEnum.MANUAL, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, ""),
//            new AbilityEntity(39L, List.of(), ActivationEnum.ON_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Ha aranyat szerzel nyersanyag gyűjtéskor, kapsz 1 <i class=\"fa fa-coins\"></i>-t.</p>"),
//            new AbilityEntity(40L, List.of("city", "hammer"), ActivationEnum.AFTER_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.OWN_CARD, "<p>Megépítesz egy kerületet úgy, hogy az Állványzatot semmisíted meg, ahelyett, hogy kifizetnéd a <i class=\"fa fa-city\"></i> árát.</p><p>Magisztrátus nem kobozhat el Állványzat álltal épített <i class=\"fa fa-city\"></i>-t.</p>"),
//            new AbilityEntity(41L, List.of(), ActivationEnum.END_OF_GAME, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A játék végén 1 <i class=\"fa fa-star\"></i> jár városodban minden olyan <i class=\"fa fa-city\"></i>-ért, aminek ára páratlan szám.</p>"),
//            new AbilityEntity(42L, List.of(), ActivationEnum.END_OF_GAME, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A játék végén 1 <i class=\"fa fa-star\"></i> jár a kincstartalékodban lévő minden <i class=\"fa fa-coins\"></i> után.</p>"),
//            new AbilityEntity(43L, List.of(), ActivationEnum.END_OF_GAME, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A játék végén 3 <i class=\"fa fa-star\"></i> jár, ha  van legalább 3 egyforma típusú <i class=\"fa fa-city\"></i> a városodban.</p><p>A Capitolium csak egyszer adhat <i class=\"fa fa-star\"></i>-t.</p>"),
//            new AbilityEntity(44L, List.of(), ActivationEnum.ON_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Ha <i class=\"fa fa-sheet-plastic\"></i>-t húzol nyersanyag gyűjtéskor, eggyel több közül választhatsz.</p>"),
//            new AbilityEntity(45L, List.of(), ActivationEnum.END_OF_GAME, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A játék végén 5 <i class=\"fa fa-star\"></i> jár, ha az Elefántcsonttorony az egyetlen <span style=\"font-variant: small-caps\">egyedi</span> <i class=\"fa fa-city\"></i> a városodban.</p>"),
//            new AbilityEntity(46L, List.of(), ActivationEnum.ON_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>8-as rangú karakter nem használhatja a képességét az Erődítményen.</p>"),
//            new AbilityEntity(47L, List.of("city", "bomb"), ActivationEnum.AFTER_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.BUILT_DISTRICT, "<p>A köröd folyamán elpusztíthatod a Fegyvertárat, hogy elpusztíts egy másik játékos városában lévő <i class=\"fa fa-city\"></i>-t.</p><p>Befejezett városban nem lehet <i class=\"fa fa-city\"></i>-t elpusztítani.</p>"),
//            new AbilityEntity(48L, List.of(), ActivationEnum.ON_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Eggyel kevesebbet fizetsz minden más, <span style=\"font-variant: small-caps\">egyedi</span> <i class=\"fa fa-city\"></i> megépítéséért.</p>"),
//            new AbilityEntity(49L, List.of(), ActivationEnum.ON_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Az Istálló megépítése nem számít bele a körre vonatkozó építési korlátba.</p><p>Ha a magisztrátus elkobozza a játékos építhet még egy <i class=\"fa fa-city\"></i>-t ebben a körben.</p>"),
//            new AbilityEntity(50L, List.of(), ActivationEnum.END_OF_GAME, AbilityUsageEnum.AND, AbilityTargetEnum.DISTRICT_TYPE, "<p>A játék végén a Kísértetváros az általad választott típusú <i class=\"fa fa-city\"></i>-nek számít.</p><p>Ha a birtokos úgy dönt, hogy a Kísértetváros típusa nem <span style=\"font-variant: small-caps\">egyedi</span>, akkor többé nem számít annak.</p>"),
//            new AbilityEntity(51L, List.of(), ActivationEnum.END_OF_GAME, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A játék végén 1 <i class=\"fa fa-star\"></i> jár a városodban lévő minden <span style=\"font-variant: small-caps\">egyedi</span> <i class=\"fa fa-city\"></i> után (beleértve a Kívánságkutat is).</p>"),
//            new AbilityEntity(52L, List.of("coins", "left-right", "sheet-plastic"), ActivationEnum.AFTER_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A köröd folyamán egyszer 2 <i class=\"fa fa-coins\"></i>-ért 3 <i class=\"fa fa-sheet-plastic\"></i>-t húzhatsz.</p>"),
//            new AbilityEntity(53L, List.of(), ActivationEnum.ON_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Ha <i class=\"fa fa-sheet-plastic\"></i>-t húzol nyersanyag gyűjtéskor, eggyel több <i class=\"fa fa-sheet-plastic\"></i>-t tarts meg.</p>"),
//            new AbilityEntity(54L, List.of(), ActivationEnum.ON_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Bármennyi egyforma <i class=\"fa fa-city\"></i>-t építhetsz a városodban.</p><p>8-as rangú karakter nem használhatja a képességét egyforma <i class=\"fa fa-city\"></i> megszerzésére.</p>"),
//            new AbilityEntity(55L, List.of("sheet-plastic", "left-right", "coins"), ActivationEnum.AFTER_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.OWN_CARD, "<p>A köröd folyamán egyszer eldobhatsz egy <i class=\"fa fa-sheet-plastic\"></i>-t a kezedből és kapsz 2 <i class=\"fa fa-coins\"></i>-t.</p>"),
//            new AbilityEntity(56L, List.of(), ActivationEnum.ON_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A 8-as rangú karakternek eggyel több <i class=\"fa fa-coins\"></i>-t kell fizetnie, hogy használhassa a képességét városodban lévő bármely más <i class=\"fa fa-city\"></i>-en.</p>"),
//            new AbilityEntity(57L, List.of(), ActivationEnum.ON_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Ha nincs <i class=\"fa fa-sheet-plastic\"></i> a kezedben a köröd végén, húzol két <i class=\"fa fa-sheet-plastic\"></i>-t.</p><p>Ha a birtokos a Boszorkány és nincs megbabonázott köre, akkor a Park képessége nem lép életbe.</p>"),
//            new AbilityEntity(58L, List.of(), ActivationEnum.END_OF_GAME, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A játék végén 2 <i class=\"fa fa-star\"></i> jár.</p>"),
//            new AbilityEntity(59L, List.of(), ActivationEnum.ON_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>Ha nincs <i class=\"fa fa-coins\"></i> a kincstartalékodban a köröd végén, kapsz 1 <i class=\"fa fa-coins\"></i>-t.</p><p>Ha a birtokos a Boszorkány és nincs megbabonázott köre, akkor a Szegényház képessége nem lép életbe.</p><p>Az alkímista képessége a Szegényház hatása után érvényesül.</p>"),
//            new AbilityEntity(60L, List.of(), ActivationEnum.END_OF_GAME, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A játék végén 5 <i class=\"fa fa-star\"></i> jár, ha nálad van a <i class=\"fa fa-crown\"></i>.</p>"),
//            new AbilityEntity(61L, List.of("city", "x", "hammer"), ActivationEnum.BEFORE_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.OWN_BUILT_DISTRICT, "<p>Megépítheted úgy a Temetőt, hogy elpusztítasz egy <i class=\"fa fa-city\"></i>-t a városodban, ahelyett, hogy kifizetnéd a Temető árát.</p><p>Magisztrátus nem kobozhat el Temetőt ami a képessége által lett építve.</p>"),
//            new AbilityEntity(62L, List.of(), ActivationEnum.END_OF_GAME, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A játék végén 1 <i class=\"fa fa-star\"></i> jár minden kezedben maradt <i class=\"fa fa-sheet-plastic\"></i> után.</p>"),
//            new AbilityEntity(63L, List.of("hammer", "sheet-plastic"), ActivationEnum.BEFORE_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.OWN_CARDS, "<p>Építéskor a Tolvajtanya árát fizetheted részben <i class=\"fa fa-sheet-plastic\"></i>-okból (1 <i class=\"fa fa-sheet-plastic\"></i> = 1 <i class=\"fa fa-coins\"></i>).</p><p>Ha a magisztrátus elkobozza a Tolvajtanyát csak az <i class=\"fa fa-coins\"></i>-t kapja vissza a tulajdonos.</p>"),
//            new AbilityEntity(64L, List.of(), ActivationEnum.ON_BUILD, AbilityUsageEnum.AND, AbilityTargetEnum.NONE, "<p>A kerületekhez nyersanyagokat gyűjtő képességeket tekintve a Varázstanoda az általad választott típusú kerületnek számít.</p>"));
